...
public class SellingRecycleAdapter extends RecyclerView.Adapter<SellingRecycleAdapter.ViewHolder> {
    ...
    public SellingRecycleAdapter(List<CommodityHome> mCommodityHome, Me activity, int code) {
    ...
    @Override
    public SellingRecycleAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if(mContext == null){
            mContext = parent.getContext();
        }
        View view = LayoutInflater.from(mContext).inflate(R.layout.home_commodity_itemcard, parent, false);
        return new SellingRecycleAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(SellingRecycleAdapter.ViewHolder holder, int position) {
